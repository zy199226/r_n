...
class PTmain extends Component {
    ...
    publish() {
        ...
        let title = this.refs.title.refs.textarea.value;
        let content = this.refs.content.refs.textarea.value;
    ...
    render() {
        ...
        return (
            <div style={{
                ...
                <TextareaItem ref='title' placeholder='请输入标题，不少于10个字符' autoHeight style={{
                    background: '#f8f8f8',
                    marginTop: '1rem'
                }} />
                <TextareaItem ref='content' placeholder='请输入内容' autoHeight style={{
                    background: '#f8f8f8',
                    marginTop: '1rem'
                }} />
